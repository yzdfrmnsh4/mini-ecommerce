...
Route::get('pesanan_saya', [user_authcontroller::class, 'pesanan_saya_view'])->name("pesanan_saya_view");
Route::get('profile_view', [user_authcontroller::class, 'profile_view'])->name("profile_view");
//edit profile user
