...
<body>
    <div class="text-center mb-6">
        <h1 class="text-lg font-semibold">Laporan Penjualan</h1>
        <p class="text-xs text-gray-500">Periode: Januari {{ Carbon\Carbon::now()->format('Y') }}</p>
    </div>
    ...
    <div class="overflow-hidden border border-gray-200 rounded-md">
        <table class="w-full border-collapse">
            <thead class="bg-gray-100 text-gray-700">
                <tr>
                    <th class="px-3 py-2 text-center text-xs font-semibold uppercase">No</th>
                    <th class="px-3 py-2 text-xs font-semibold uppercase">Kode</th>
                    <th class="px-3 py-2 text-xs font-semibold uppercase">Tanggal</th>
                    <th class="px-3 py-2 text-xs font-semibold uppercase">Produk</th>
                    <th class="px-3 py-2 text-right text-xs font-semibold uppercase">Harga</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @foreach ($transaksi as $item)
                    <tr>
                        ...
                        <td class="px-3 py-2">{{ $item->kode_transaksi }}</td>
                        <td class="px-3 py-2">{{ \Carbon\Carbon::parse($item->created_at)->format('d F Y') }}</td>
                        <td class="px-3 py-2">
                            <div class="">
                                @foreach ($item->detail_transaksi as $data)
                                    <a class="bg-slate-100 p-2 ">{{ $data->produk->nama_prod }}
                                        x{{ $data->qty }}</a>
                                    <hr>
                                    <br>
                                @endforeach
                        ...
                        <td class="px-3 py-2 text-right ">
                            <div class="">
                                @foreach ($item->detail_transaksi as $data)
                                    <a class="bg-slate-100 p-2 ">{{ $data->harga }}</a>
                                    <hr>
                                    <br>
                                @endforeach
                            </div>
                        </td>
                        <td class="px-3 py-2 text-center">{{ $item->total_barang }}</td>

                        <td class="px-3 py-2 text-right">{{ $item->total_harga }}</td>
                    </tr>
                @endforeach
            ...
            <tfoot class="bg-gray-50 font-semibold">
                <tr>
                    ...
                    <td class="px-3 py-2 text-right">{{ $transaksi->pluck('total_harga')->sum() }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
