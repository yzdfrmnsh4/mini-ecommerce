    ...
    <div class="min-h-screen bg-gray-50 py-12">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                ...
                <a href="#" class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-all shadow-md">
                    Lanjut Belanja
                </a>
            </div>
            ...
            <div class="flex flex-wrap gap-3 mb-10">
                ...
                <button class="px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors">Menunggu Pembayaran</button>
                <button class="px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors">Sedang Dikirim</button>
                <button class="px-6 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors">Selesai</button>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300">
                    <div class="p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-gray-100">
                        <div>
                            <p class="text-sm text-gray-500">Pesanan #ORD-20260115-001 • 15 Jan 2026</p>
                            <p class="text-xl font-bold text-gray-900 mt-1">Rp 1.850.000</p>
                        </div>
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div class="flex gap-6">
                            <div class="w-24 h-24 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                                <img src="https://placehold.co/100x100/png?text=Produk" alt="Produk" class="w-full h-full object-cover">
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="mt-8 flex flex-col sm:flex-row gap-4">
                            <a href="#" class="flex-1 bg-indigo-600 text-white font-semibold py-3 rounded-xl hover:bg-indigo-700 transition-all text-center">
                                Lihat Detail Pesanan
                            </a>
                            <a href="#" class="flex-1 bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 rounded-xl hover:bg-gray-50 transition-all text-center">
                                Beli Lagi
                            </a>
                        </div>
                    </div>
